...
const mutation = `
    ...
    setClient(category: String, _id: ID!, device: String, image: Upload, name: String, city: String, phone: [String], login: String, email: String, address: [[String]], inn: String, info: String, newPass: String): Data
